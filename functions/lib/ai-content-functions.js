 ...
 */
exports.aiSuggestTopics = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        const templates = TOPIC_TEMPLATES[targetCategory]
        ...
        if (suggestions.length < count) {
            ...
            for (const cat of otherCategories) {
                const catTemplates = TOPIC_TEMPLATES[cat];
...
//# sourceMappingURL=ai-content-functions.js.map